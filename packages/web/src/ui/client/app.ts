...
import { setTypeScriptApi, isReady as isAstReady, findEntityDefinitions, findScenarios, type EntityDefinitionLocation, type ScenarioLocation } from './ast-analyzers.js';
