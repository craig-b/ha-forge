...
import type { Monaco, MonacoMarkerData, MonacoCodeAction, MonacoRange, MonacoDocumentSymbol, MonacoModelInstance, MonacoDecorationOptions, MonacoDecorationsCollection, MonacoEditorInstance, OpenFileInternal } from './monaco-types.js';
